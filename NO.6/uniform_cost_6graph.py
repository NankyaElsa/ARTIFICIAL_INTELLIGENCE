#N0.6c
#This program demonstrates the Uniform cost search algorithm using python for graph, prints out
...
def ucs_graph(graph, start, goal):
    ...
    while priority_queue:  # while queue is not empty
        ...
        visited.add(current_node)  # if node is not visited, add it to the visited set
...
result = ucs_graph(adj_list3, start_node, goal_node)

if result:
    print("Shortest Path, UCS:", result)
else:
    print("No path found.")
